...
module.exports = function detailcard (movie){
  ...
  let HTML = `<div id="movieid" class="moviedetail" data-movieid="${movie.id}" >
        <div class="mask">
            <div class="container">
                <div class="col-xs-4">
                    <img class="detailposter" src='https://image.tmdb.org/t/p/w500/${movie.poster_path}' />
                </div>
                <div class="col-xs-8">
